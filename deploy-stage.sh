...
docker run --env-file ../.env.stage -v /root/jewerly-shop/api/logs/stage:/logs --rm -d --restart always --publish 8001:8000 --name jewerly-api-stage --link=jewerly-db:db jewerly-api:0.1